  ...
  return (
    <div className="App">
      <div className="App-header">
        <Title>WebRTC</Title>
        <Paragraph>
          This is a simple demo app that demonstartes how to build a WebRTC
          application from scratch.
        </Paragraph>
        <button onClick={() => console.log(props.isStreamer)}>
          consoling isStreamer?
        </button>
        ...
        >
          <div>
            <Title style={{ padding: "0px", margin: "0px" }}>REMOTE</Title>
            <video
              id="peerPlayer"
              autoPlay
          ...
          <div>
            <Title style={{ padding: "0px", margin: "0px" }}>LOCAL</Title>
            <video
              id="localPlayer"
              autoPlay
              style={{ width: 640, height: 480 }}
