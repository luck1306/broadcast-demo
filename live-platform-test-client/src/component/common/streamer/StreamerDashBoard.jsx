...
const StreamerDashBoard = () => {
    ...
    const userId = token.nickname + "#" + crypto.randomUUID().slice(0, 4);
    ...
    const [streammingReady, setStreammingReady] = useState(true);
